const errorCodes = {
  ...
  '08': {
    title: "Host Name, doesn't match",
    message: 'Please check your API or Create a new config file..',
    details: "Existing config file you have mentioned doesn't match API base path.",
  },
};

module.exports = {
  errorMessage: code => errorCodes[code],
};
